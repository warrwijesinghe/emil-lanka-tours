...
const aliases: Array<[string, string]> = [
  ...
  ['dambulla', 'dambulla'], ['demodara', 'demodara'], ['haputale', 'haputale'], ['kaudulla', 'kaudulla-national-park'], ['madu river', 'madu-river'], ['mannarama', 'mannar'], ['mannar', 'mannar'], ['minneriya', 'minneriya-national-park'], ['nanu oya', 'nanu-oya'], ['nanuoya', 'nanu-oya'], ['nilaveli', 'nilaveli'], ['rakawa', 'rekawa'], ['rekawa', 'rekawa'], ['ritigala', 'ritigala'], ['sinharaja', 'sinharaja'], ['singharaja', 'sinharaja'], ['deniyaya', 'sinharaja'], ['sorabora', 'sorabora-lake'], ['tangalla', 'tangalle'], ['tangalle', 'tangalle'], ['tissamaharama', 'tissamaharama'], ['uppuveli', 'uppuveli'],
  ['mihintale', 'mihintale'], ['horton plains', 'horton-plains-national-park'], ['bundala', 'bundala-national-park'], ['weligama', 'weligama'], ['panama beach', 'panama'], ['panama', 'panama'], ['kinniya', 'kinniya'], ['marble beach', 'marble-beach']
];
