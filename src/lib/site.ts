...
export const mainNav = [
  ...
  { href: '/destinations/', label: 'Destinations' }, { href: '/experiences/', label: 'Experiences' }, { href: '/travel-guide/', label: 'Travel Guide' }, { href: '/about/', label: 'About Emil' }, { href: '/contact/', label: 'Contact' }
];
export const footerExploreLinks = mainNav.slice(1, 6);
